...
RcppExport SEXP _EasyMMD_kernelMatrix_poly_sum(SEXP x_obsSEXP, SEXP x_simSEXP, SEXP sigmaSEXP, SEXP degreeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x_obs(x_obsSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type x_sim(x_simSEXP);
    Rcpp::traits::input_parameter< float >::type sigma(sigmaSEXP);
    Rcpp::traits::input_parameter< float >::type degree(degreeSEXP);
    rcpp_result_gen = Rcpp::wrap(kernelMatrix_poly_sum(x_obs, x_sim, sigma, degree));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_EasyMMD_kernelMatrix_poly_sum", (DL_FUNC) &_EasyMMD_kernelMatrix_poly_sum, 4},
    {NULL, NULL, 0}
};
